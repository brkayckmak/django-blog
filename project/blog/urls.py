...
from blog.views import contact, mainpage, category_list_view, my_writings, detail_view, add_writing_create_view, update_writing, delete_writing_delete_view, delete_comment
